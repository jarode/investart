                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="button--group">
                                        ...
                                        @if (request()->routeIs('admin.users.ckyc.pending'))
                                        <a href="{{ route('admin.users.ckyc.details', $user->id) }}" target="_blank" class="btn btn-sm btn-outline--info">
                                            <i class="las la-user-check"></i>@lang('Case KYC Data')
                                        </a>
                                        @endif
                                    </div>
                                </td>
