    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="row mt-4">
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--19">
                        ...
                        <div class="widget-two__content">
                            <h3 class="text-white">{{ $totalCase }}</h3>
                            <p class="text-white">@lang('Total Case')</p>
                        </div>
                        <a href="{{ route('admin.cases.list') }}?search={{ $user->username }}" class="widget-two__btn">@lang('View All')</a>
                    </div>
                </div>
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--primary">
                        ...
                        <div class="widget-two__content">
                            <h3 class="text-white">{{ $invest }}</h3>
                            <p class="text-white">@lang('Total Invest')</p>
                        </div>
                        <a href="{{ route('admin.invest.list') }}?search={{ $user->username }}" class="widget-two__btn">@lang('View All')</a>
                    </div>
                </div>
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--primary">
                        ...
                        <div class="widget-two__content">
                            <h3 class="text-white">{{ $general->cur_sym }}{{ showAmount($totalInvest) }}</h3>
                            <p class="text-white">@lang('Total Invest Amount')</p>
                        </div>
                        <a href="{{ route('admin.invest.list') }}?search={{ $user->username }}" class="widget-two__btn">@lang('View All')</a>
                    </div>
                </div>
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--17">
                        ...
                        <div class="widget-two__content">
                            <h3 class="text-white">{{ $general->cur_sym }}{{ showAmount($totalProfit) }}</h3>
                            <p class="text-white">@lang('Total Profit')</p>
                        </div>
                        <a href="{{ route('admin.invest.return.profit') }}?search={{ $user->username }}" class="widget-two__btn">@lang('View All')</a>
                    </div>
                </div>
            ...
            <div class="d-flex flex-wrap gap-3 mt-4">
                ...
                @if ($user->ckv_data)
                    <div class="flex-fill">
                        <a href="{{ route('admin.users.ckyc.details', $user->id) }}" target="_blank" class="btn btn--primary btn--shadow w-100 btn-lg">
                            <i class="las la-user-check"></i>@lang('Case Creator KYC Data')
                        </a>
                    </div>
                @endif
                    ...
                    <form action="{{ route('admin.users.update', [$user->id]) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-2 col-sm-12">
                                <label>@lang('Case Creator KYC') </label>
                                <input type="checkbox" data-width="100%" data-height="50" data-onstyle="-success" data-offstyle="-danger"
                                    data-bs-toggle="toggle" data-on="@lang('Verified')" data-off="@lang('Unverified')" name="ckv"
                                    @if ($user->ckv == 1) checked @endif>
                            </div>
                        </div>
