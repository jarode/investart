            ...
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{ menuActive('admin.invest*', 3) }}">
                        ...
                        <span class="menu-title">@lang('Manage Investment') </span>
                    </a>
                    <div class="sidebar-submenu {{ menuActive('admin.invest*', 2) }} ">
                        <ul>
                            <li class="sidebar-menu-item {{ menuActive(['admin.invest.return.profit']) }}">
                                <a href="{{ route('admin.invest.return.profit') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('All Profit')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{ menuActive(['admin.invest.list']) }}">
                                <a href="{{ route('admin.invest.list') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('All Invest')</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{ menuActive('admin.cases*', 3) }}">
                        <i class="menu-icon las la-file-invoice-dollar"></i>
                        <span class="menu-title">@lang('Manage Cases')</span>

                        @if (0 < $pendingCaseCount)
                            <span class="menu-badge pill bg--danger ms-auto">
                                <i class="fa fa-exclamation"></i>
                            </span>
                        @endif
                    </a>
                    <div class="sidebar-submenu {{ menuActive('admin.cases*', 2) }} ">
                        <ul>
                            <li class="sidebar-menu-item {{ menuActive('admin.cases.pending') }} ">
                                <a href="{{ route('admin.cases.pending') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Pending Cases')</span>
                                    @if ($pendingCaseCount)
                                        <span class="menu-badge pill bg--danger ms-auto">{{ $pendingCaseCount }}</span>
                                    @endif
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{ menuActive('admin.cases.approved') }} ">
                                <a href="{{ route('admin.cases.approved') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Approved Cases')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{ menuActive('admin.cases.reached') }} ">
                                <a href="{{ route('admin.cases.reached') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Reached Cases')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{ menuActive('admin.cases.rejected') }} ">
                                <a href="{{ route('admin.cases.rejected') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Rejected Cases')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{ menuActive('admin.cases.list') }} ">
                                <a href="{{ route('admin.cases.list') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('All Cases')</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                </li>
                <li class="sidebar-menu-item  {{ menuActive('admin.schedule.index') }}">
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{ menuActive('admin.users*', 3) }}">
                        ...
                        @if (
                            $bannedUsersCount > 0 ||
                                ...
                                $ckycPendingUsersCount > 0 || 
                                $ckycUnverifiedUsersCount > 0)
                            <span class="menu-badge pill bg--danger ms-auto">
                                <i class="fa fa-exclamation"></i>
                            </span>
                        @endif
                    ...
                    <div class="sidebar-submenu {{ menuActive('admin.users*', 2) }} ">
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.users.ckyc.unverified') }}">
                                <a href="{{ route('admin.users.ckyc.unverified') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Case KYC Unverified')</span>
                                    @if ($ckycUnverifiedUsersCount)
                                        <span class="menu-badge pill bg--danger ms-auto">{{ $ckycUnverifiedUsersCount }}</span>
                                    @endif
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{ menuActive('admin.users.ckyc.pending') }}">
                                <a href="{{ route('admin.users.ckyc.pending') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Case KYC Pending')</span>
                                    @if ($ckycPendingUsersCount)
                                        <span class="menu-badge pill bg--danger ms-auto">{{ $ckycPendingUsersCount }}</span>
                                    @endif
                                </a>
                            </li>
                ...
                <li class="sidebar-menu-item {{ menuActive('admin.case.creator.kyc.setting') }}">
                    <a href="{{ route('admin.case.creator.kyc.setting') }}" class="nav-link">
                        <i class="menu-icon las la-user-check"></i>
                        <span class="menu-title">@lang('Case KYC Setting')</span>
                    </a>
                </li>
