...
@section('panel')
    ...
    <div class="row gy-4">
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="2" link="{{ route('admin.cases.list') }}" icon="fas fa-hand-holding-usd"
                icon_style="false" title="Total Cases" value="{{ $case['total_cases'] }}" color="success" />
        </div>
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="2" link="{{ route('admin.cases.pending') }}" icon="fas fa-spinner" icon_style="false"
                title="Pending Cases" value="{{ $case['total_pending_cases'] }}" color="warning" />
        </div>
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="2" link="{{ route('admin.cases.approved') }}" icon="fas fa-ban" icon_style="false"
                title="Approved Cases" value="{{ $case['total_approved_cases'] }}" color="danger" />
        </div>
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="2" link="{{ route('admin.cases.rejected') }}" icon="fas fa-percentage" icon_style="false"
                title="Rejected Cases" value="{{ $case['total_rejected_cases'] }}" color="primary" />
        </div>
    </div>

    {{-- <div class="row gy-4 mt-2">
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="2" link="{{ route('admin.report.investor') }}" icon="lar la-user"
                title="Total Investor"
                value="{{ $widget['total_investor'] }}" color="success" />
        </div>

        <div class="col-xxl-3 col-sm-6">
            <x-widget style="2" link="{{ route('admin.report.invest') }}" icon="las la-money-bill-wave"
                title="Total Invest"
                value="{{ $general->cur_sym }}{{ showAmount($widget['total_investor_amount']) }}" color="primary" />
        </div>

        <div class="col-xxl-3 col-sm-6">
            <x-widget style="2" link="{{ route('admin.report.return.profit') }}" icon="lar la-credit-card"
                title="Return Profit"
                value="{{ $general->cur_sym }}{{ showAmount($widget['total_return_profit']) }}" color="info" />
        </div>

        <div class="col-xxl-3 col-sm-6">
            <x-widget style="2" link="{{ route('admin.report.pending.profit') }}" icon="las la-sync"
                title="Pending Return"
                value="{{ $general->cur_sym }}{{ showAmount($widget['total_pending_return_profit']) }}" color="danger" />
        </div>
