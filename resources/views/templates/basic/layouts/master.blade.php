...
<body>
    ...
    @if (!request()->is('home'))
        ...
        <section class="breadcrumb bg-img"
            data-background-image="{{ sectionImage('breadcrumb', @$breadcrumb->data_values->background_image, '1920x660') }}">
            <div class="container">
    ...
    @include($activeTemplate.'partials.profile_top')
    ...
    <script src="{{ asset($activeTemplateTrue . 'js/master.js') }}"></script>
