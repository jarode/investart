                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        <div class="card custom--card">
                            <div class="card-header border-0  gap-2 flex-align justify-content-between">
                                <h3 class="card-title mb-0">@lang('Withdraw Money')</h3>
                                <a href="{{ route('user.withdraw.history') }}" class="btn btn--base btn--sm"> <i class="fa fa-list"></i>
                                    @lang('Withdraw List')</a>
                            </div>
                            <div class="card-body">
                                <form action="{{ route('user.withdraw.money') }}" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <span class="mt-1"><span>@lang('Available balance')</span> <span
                                                class="text--base">{{ showAmount(auth()->user()->balance) . ' ' . __($general->cur_text) }}</span></span>
                                    </div>
