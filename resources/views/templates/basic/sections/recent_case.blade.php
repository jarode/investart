@php
    $content = getContent('recent_case.content', true);
    $recentCase = \App\Models\InvestmentCase::take(6)
        ->validated()
        ->active()
        ->approved()
...
<section class="popular-case py-60">
    <div class="container">
        ...
        <div class="case-card-slider recent-case-card-slider">
            @forelse ($recentCase as $recent)
                @include($activeTemplate . 'invest_card', ['data' => $recent, 'showExpiredDate' => false])
            @empty
