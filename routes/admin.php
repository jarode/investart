...
Route::middleware('admin')->group(function () {
    ...
    Route::controller('ManageUsersController')->name('users.')->prefix('users')->group(function () {
        ...
        Route::get('case/kyc-unverified', 'ckycUnverifiedUsers')->name('ckyc.unverified');
        Route::get('case/kyc-pending', 'ckycPendingUsers')->name('ckyc.pending');
        ...
        Route::get('case/kyc-data/{id}', 'ckycDetails')->name('ckyc.details');
        Route::post('case/kyc-approve/{id}', 'ckycApprove')->name('ckyc.approve');
        Route::post('case/kyc-reject/{id}', 'ckycReject')->name('ckyc.reject');
    ...
    //manage cases
    Route::controller('ManageCasesController')->prefix('cases')->name('cases.')->group(function () {
        Route::get('/', 'cases')->name('list');
        Route::get('pending', 'pending')->name('pending');
        Route::get('rejected', 'rejected')->name('rejected');
        Route::get('approved', 'approved')->name('approved');
        Route::get('reached', 'reached')->name('reached');
        Route::get('details/{id}', 'details')->name('details');
        Route::post('reject', 'reject')->name('reject');
        Route::post('approve/{id}', 'approve')->name('approve');
        Route::get('download/agreement/{id}', 'download')->name('download');
    });
    ...
    Route::controller('InvestmentController')->prefix('invest')->name('invest.')->group(function () {
        Route::get('all/profit', 'profit')->name('return.profit');
        Route::get('invest', 'invest')->name('list');
    });
    ...
    Route::controller('KycController')->group(function () {
        ...
        Route::get('case/creator/kyc-setting', 'caseCreatorKycSetting')->name('case.creator.kyc.setting');
        Route::post('case/creator/kyc-setting', 'caseCreatorKycSettingUpdate');
    });
