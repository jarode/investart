...
class AdminController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        $widget['total_investor'] = Invest::distinct()->count('user_id');
        $widget['total_investor_amount'] = Invest::sum('invest_amount');
        $widget['total_return_profit'] = ProfitReturn::active()->sum('profit_amount');
        $widget['total_pending_return_profit'] = ProfitReturn::inactive()->sum('profit_amount');

        $case['total_cases'] = InvestmentCase::whereNot('status',Status::CASE_DRAFT)->count();
        $case['total_pending_cases'] = InvestmentCase::pending()->count();
        $case['total_approved_cases'] = InvestmentCase::approved()->count();
        $case['total_rejected_cases'] = InvestmentCase::rejected()->count();
        ...
        return view('admin.dashboard', compact('pageTitle','case','widget', 'chart','deposit','withdrawals','depositsMonth','withdrawalMonth','months','trxReport','plusTrx','minusTrx'));
    }
