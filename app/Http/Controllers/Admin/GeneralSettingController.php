...
class GeneralSettingController extends Controller
{
    ...
    public function update(Request $request)
    {
        $request->validate([
            ...
            'verified_badge_price' => 'required|numeric|gt:0',
            'profit_commission'    => 'required|numeric|gt:0|lt:100',
        ...
        $general->verified_badge_price = $request->verified_badge_price;
        $general->profit_commission    = $request->profit_commission;
    ...
    public function systemConfigurationSubmit(Request $request)
    {
        ...
        $general->ckv = $request->ckv ? Status::ENABLE : Status::DISABLE;
        ...
        $general->case_approve = $request->case_approve ? Status::ENABLE : Status::DISABLE;
        $general->save();
